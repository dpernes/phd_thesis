...
\input{Chapters/chp_intro}
\input{Chapters/chp_background}
\input{Chapters/chp_networked_data_streams}
\input{Chapters/chp_da}
\input{Chapters/chp_dg}
\input{Chapters/chp_conclusion}
...
\input{Appendices/appendix_spamhmm}
\input{Appendices/appendix_modafm}
\input{Appendices/appendix_desire}
