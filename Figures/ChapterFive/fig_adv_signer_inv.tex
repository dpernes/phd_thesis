...
% Text Node
\draw (215.7,74.44) node   {$g(\boldsymbol{X}\mathrm{;}\boldsymbol{\theta _{g}})$};
% Text Node
\draw (387.48,20.66) node  [align=left] {{\small \textit{Sign-classifier:}}};
% Text Node
\draw (448.89,20.95) node   {$h(\boldsymbol{z}\mathrm{;}\mathnormal{\theta _{h}})$};
% Text Node
\draw (393.24,162.34) node  [align=left] {{\small \textit{Signer-classifier:}}};
% Text Node
\draw (456.63,161.64) node   {$d(\boldsymbol{z}\mathrm{;}\boldsymbol{\theta _{d}})$};
% Text Node
\draw (589.25,204.03) node   {${\textstyle \mathcal{\textcolor[rgb]{0.82,0.01,0.11}{L}}\textcolor[rgb]{0.82,0.01,0.11}{_{\mathrm{signer}}}}$};
% Text Node
\draw (489.39,48.2) node   {$p( \mathrm{y} \mid \boldsymbol{z}_{i} ;\boldsymbol{\theta _{h}})$};
% Text Node
...
% Text Node
\draw (215.7,357.44) node   {$g(\boldsymbol{X}\mathrm{;}\boldsymbol{\theta _{g}})$};
% Text Node
...
% Text Node
\draw (489.89,190.7) node   {$p( \mathrm{s} \mid \boldsymbol{z}_{i} ;\boldsymbol{\theta _{g}})$};
...
\caption{The architecture of the proposed signer-invariant neural network. It comprises three main sub-networks or blocks, i.e.\ an encoder, a sign-classifier and a signer-classifier.}
