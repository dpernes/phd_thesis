...
\begin{proposition}
	...
	Let $\sP_M$ be the set of all probability distributions over the set $\{1,2\cdots,m\}$ and $M>1$. We have:
	\begin{enumerate}
...
\begin{table*}
	...
	\end{tabular}}
	\caption{Mean angle error for short-term motion prediction on Human3.6M for different actions and time horizons. The results for ERD, LSTM-3LR, SRNN, GRU supervised and QuaterNet were extracted from \cite{Pavllo2018}. Best results among our models are in bold, best overall results are underlined.}
