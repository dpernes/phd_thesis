...
\begin{figure}
	...
	\resizebox{.90\textwidth}{!}{
		...
		\end{tikzpicture}}
	\caption{Representation of the model as a Bayesian network. The node $\rz$ is a parent of all nodes inside the dashed box (the connections were omitted for clarity). Grayed nodes represent latent variables.}
