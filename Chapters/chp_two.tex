...
For the purpose of modeling AP usage data, we should consider a slightly different setting where each observation $x^{(\tau)}$ takes values on the $d$-dimensional plane $\sR^d$, rather than being drawn from a discrete dictionary. 
