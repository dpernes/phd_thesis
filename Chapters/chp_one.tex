...
Variational methods are used as approximation methods in a wide variety of settings, from quantum mechanics (\citet{Sakurai2017}) to statistics (\citet{Rustagi1976}). The application of these techniques converts a complex problem into a simpler one, where thesimpler problem is generally characterized by a decoupling of the degrees of freedom in theoriginal problem (\citet{Jordan1999}).