...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_1.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_2.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_3.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_4.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_5.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_6.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_7.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_8.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/triesch_9.png}}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_1.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_2.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_3.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_4.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_6.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_7.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_8.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_9.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFour/MKLM_10.png}}
        \caption{MKLM}
        \label{fig:mklm}
    \end{subfigure}
...
\end{equation}
where $\vz_{i}$ is sampled from $q(\rvz_{i} \mid \mX^{(r_{i})}_{y_{i},s_{i}}, y_{i}, s_{i}; \vtheta_e)$ using the reparameterization trick (see \Secref{sec:vae_encoder_grad}), and $j$ is such that $y_j=y_i$, $s_{j}$ is sampled from a distribution $w(\rs \mid s_{i})$, defined below, and $r_{j}$ is sampled uniformly from the set of available repetitions:
\begin{equation}
