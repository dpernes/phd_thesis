...
A full schematic of the DeSIRe model is included in Appendix~\ref{sec:desire_arch}, where details about the model architecture are also provided. A few training heuristics which were employed to improve the training of the model are described in Appendix~\ref{sec:desire_training}.
