...
\begin{figure}[t]
    \centering
    \subfloat{\includegraphics[width=0.15\textwidth]{ChapterFive/1.png}}
    \hfill
    \subfloat{\includegraphics[width=0.15\textwidth]{ChapterFive/4.png}}
    \hfill
    \subfloat{\includegraphics[width=0.15\textwidth]{ChapterFive/3.png}}
    \\\vspace{0.4cm}
    \subfloat{\includegraphics[width=0.15\textwidth]{ChapterFive/2.png}}
    \hfill
    \subfloat{\includegraphics[width=0.15\textwidth]{ChapterFive/5.png}}
    \hfill
    \subfloat{\includegraphics[width=0.15\textwidth]{ChapterFive/6.png}}
...
The remainder of this section is organized as follows. \Secref{sec:adv_signer_inv_rel_work} introduces the related work on SLR. The proposed model, along with its adversarial training scheme, is fully described in \Secref{sec:adv_signer_inv_method}. The experimental results and conclusions are reported in Sections~\ref{sec:adv_signer_inv_experiments} and \ref{sec:adv_signer_inv_conclusion}, respectively.
...
Although the aforementioned methods have promoted a significant evolution in the signer-independent research, there is still much room for improvement. A major weakness of all methods is the fact that representation and metric learning are not performed jointly. It is well known that the recent success of deep learning approaches, particularly those using CNNs, in tasks like object detection and recognition, has been extended to the SLR problem. The underlying motivation is to automatically learn multiple levels of representations directly from the data (\citet{Pigou2015, Koller2016, Wu2016, Neverova2016, Kumar2017}). However, none of these methods explicitly enforces that the learned representations are signer-invariant.
...
As illustrated in \Figref{fig:model_archi}, the architecture of the proposed model is composed of three main subnetworks: an encoder, a sign-classifier, and a signer-classifier.
...
\input{Figures/ChapterFive/fig_adv_signer_inv.tex}
...
\begin{figure}[t]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_1.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_2.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_3.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_4.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_5.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_6.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_7.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_8.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/triesch_9.png}}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \setlength{\fboxsep}{0pt}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_1.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_2.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_3.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_4.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_6.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_7.png}} \\\vspace{3px}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_8.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_9.png}}
        \fbox{\includegraphics[height=\altura\textheight, keepaspectratio]{ChapterFive/MKLM_10.png}}
        \caption{MKLM}
        \label{fig:mklm}
    \end{subfigure}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \includegraphics[width=\textwidth]{ChapterFive/tsne_baseline.png}
        \caption{CNN -- baseline 1}
        \label{fig:adv_signer_inv_tsne_a}
    \end{subfigure}
    %\hfill%
    \begin{subfigure}[t]{0.32\textwidth}
        \includegraphics[width=\textwidth]{ChapterFive/tsne_triplet.png}
        \caption{CNN with triplet loss -- baseline 2}
        \label{fig:adv_signer_inv_tsne_b}
    \end{subfigure}
    %\hfill%
    \begin{subfigure}[t]{0.32\textwidth}
        \includegraphics[width=\textwidth]{ChapterFive/tsne_proposed.png}
...
\input{Figures/ChapterFive/fig_adv_iris.tex}
...
Please see \citet{AdvInvAttack2} for the results of the same model on fingerprint presentation attack detection.
...
The ultimate goal of the CVAE loss, $L_{\text{CVAE}}$, is to explicitly impose signer independence by learning latent representations which are conditionally independent of the signer identity. In this regard, $L_{\text{CVAE}}$ is defined as:
\begin{equation}
...
\subsubsection{Datasets}
We use the same datasets and follow the same experimental protocol as in our previous model, described in \Secref{sec:adv_signer_inv_experiments}. Additionally, we also evaluate our model in a subset of the CorSiL database (\citet{Ferreira2014}).
...
\begin{figure}[t]
    ...
    \begin{minipage}[t]{0.3\columnwidth}
        \begin{tikzpicture}[spy using outlines={circle,red,magnification=4,size=1.4cm, connect spies}]
            \node {\includegraphics[interpolate=true, height=0.50\columnwidth]{ChapterFive/1_psl.png}};
    ...
    \begin{minipage}[t]{0.3\columnwidth}
        \begin{tikzpicture}[spy using outlines={circle,red,magnification=4,size=1.4cm, connect spies}]
            \node {\includegraphics[interpolate=true, height=0.50\columnwidth]{ChapterFive/2_psl.png}};
    ...
    \begin{minipage}[t]{0.3\columnwidth}
        \begin{tikzpicture}[spy using outlines={circle,red,magnification=4,size=1.4cm, connect spies}]
            \node {\includegraphics[interpolate=true, height=0.50\columnwidth]{ChapterFive/3_psl.png}};
    ...
    \begin{minipage}[t]{0.3\columnwidth}
        \begin{tikzpicture}[spy using outlines={circle,red,magnification=4,size=1.4cm, connect spies}]
            \node {\includegraphics[interpolate=true, height=0.50\columnwidth]{ChapterFive/4_psl.png}};
    ...
    \begin{minipage}[t]{0.3\columnwidth}
        \begin{tikzpicture}[spy using outlines={circle,red,magnification=4,size=1.4cm, connect spies}]
            \node {\includegraphics[interpolate=true, height=0.50\columnwidth]{ChapterFive/5_psl.png}};
    ...
    \begin{minipage}[t]{0.3\columnwidth}
        \begin{tikzpicture}[spy using outlines={circle,red,magnification=4,size=1.4cm, connect spies}]
            \node {\includegraphics[interpolate=true, height=0.50\columnwidth]{ChapterFive/6_psl.png}};
