...
% Thesis front title
\fronttitle{Learning from multi-entity data}
...
% Book spine title
\spinetitle{Learning from multi-entity data}
...
% Supervisor info
% Supervisor name
\supervisor[mailto:jaime.cardoso@fe.up.pt]{Jaime S. Cardoso, Professor Catedrático}
